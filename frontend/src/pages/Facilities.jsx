...
export const defaultFacilitiesContent = {
  ...
  subtitle:
    "From the science labs to the bus routes that get students there safely, every corner of our campus is built around one goal — making learning easier to reach.",
  learnMoreText: "See Details",
  ...
  facilities: [
    ...
    },
    {
      ...
      details:
        "Every route runs with an experienced driver and a staff attendant on board. Pickup times are fixed, stops are published in advance, and routes are reviewed each term as enrollment shifts.",
      imageUrl: "",
      imageZoom: 1,
      imageOffsetX: 0,
      imageOffsetY: 0,
