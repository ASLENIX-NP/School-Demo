...
/*
|--------------------------------------------------------------------------
| RED ROSE SCHOOL — ADMISSIONS PAGE
|--------------------------------------------------------------------------
| Complete replacement for the existing Admissions page.
|
| Existing backend/API functionality is preserved:
|   GET  /api/admissions/settings
|   POST /api/admissions/inquiry
|
| Existing settings fields are preserved so the admin/settings page can
| continue supplying dynamic admission content.
|
| No separate CSS file is required. The page styles are included below.
|--------------------------------------------------------------------------
*/
...
export default function AdmissionsPage({
  ...
  const [settings, setSettings] = useState(
    previewData
      ? mergeAdmissionsContent(previewData)
      : defaultSettings
  );
  ...
  useEffect(() => {
    if (previewData) {
      const merged = mergeAdmissionsContent(
        previewData
      );
    ...
    const fetchSettings = async () => {
      try {
        ...
        if (response.data?.data) {
          ...
          setFormData(
            createInitialForm(
              loadedSettings.academicSession
            )
          );
        }
      } catch (error) {
  ...
  const whyUsList =
    Array.isArray(settings.whyUs) &&
    settings.whyUs.length
      ? settings.whyUs
      : defaultSettings.whyUs;

  const timelineList =
    Array.isArray(settings.timelineSteps) &&
    settings.timelineSteps.length
      ? settings.timelineSteps
      : defaultSettings.timelineSteps;

  const eligibilityList =
    Array.isArray(
      settings.eligibilityCriteria
    ) &&
    settings.eligibilityCriteria.length
      ? settings.eligibilityCriteria
      : defaultSettings.eligibilityCriteria;
  ...
  return (
    <main className="red-rose-admissions">
      ...
      <section className="rr-admission-section rr-admission-eligibility">
        <div className="rr-admission-shell">
          <SectionHeading
            ...
            description={
              settings.eligibilityDescription
            }
          />
              ...
              (faq, index) => {
                ...
                return (
                  <div
                    ...
                    className={`rr-admission-faq-item ${
                      expanded
                        ? "expanded"
                        : ""
                    }`}
      ...
      <section
        id="rr-admission-contact"
        className="rr-admission-contact"
      >
        <div className="rr-admission-shell">
          <SectionHeading
      ...
      <style>{`
        /* ============================================================
           RED ROSE ADMISSIONS
           Burgundy + Cream + Gold visual language
           Matches the redesigned About / Contact / Gallery pages.
        ============================================================ */
        ...
        .rr-admission-loading p {
          margin: 0;
          font-size: 12px;
          font-weight: 800;
        }

        @keyframes rrAdmissionSpin {
          to {
        ...
        .rr-admission-pattern,
        .rr-admission-process-pattern,
        .rr-admission-final-pattern {
          position: absolute;
          inset: 0;
          opacity: .09;
          pointer-events: none;
        ...
        .rr-admission-hero::before {
          ...
          border-radius: 50%;
          box-shadow:
            0 0 0 60px rgba(229,200,120,.025),
            0 0 0 120px rgba(229,200,120,.018);
        }
        ...
        .rr-admission-hero::after {
          ...
          border-radius: 50%;
          box-shadow:
            0 0 0 65px rgba(229,200,120,.025),
            0 0 0 130px rgba(229,200,120,.015);
        }
        ...
        .rr-admission-glow.glow-left {
          width: 260px;
          height: 260px;
          left: 12%;
          bottom: 5%;
          background: rgba(199,154,59,.05);
          box-shadow: 0 0 120px rgba(199,154,59,.15);
        }

        .rr-admission-glow.glow-right {
          width: 300px;
          height: 300px;
          right: 12%;
          top: 12%;
          background: rgba(166,43,79,.08);
          box-shadow: 0 0 140px rgba(166,43,79,.2);
        }

        .rr-admission-hero-inner {
          position: relative;
          z-index: 4;
        ...
        .rr-admission-hero-kicker span {
          width: 28px;
          height: 1px;
          background: var(--rr-gold);
        }

        .rr-admission-status-row {
          display: flex;
          justify-content: center;
          align-items: center;
          flex-wrap: wrap;
        ...
        .rr-admission-status {
          border: 1px solid rgba(113,196,143,.3);
          color: #bde8ca;
          background: rgba(42,112,67,.17);
        }

        .rr-admission-status.closed {
          border-color: rgba(230,117,133,.3);
          color: #ffc7d0;
          background: rgba(141,35,56,.2);
        }

        .rr-admission-status i {
          width: 7px;
          height: 7px;
          border-radius: 50%;
          background: #73d38d;
        ...
        .rr-admission-status.closed i {
          background: #e97689;
        }

        .rr-admission-status i.pulse {
          animation: rrAdmissionPulse 1.6s ease-in-out infinite;
        }

        @keyframes rrAdmissionPulse {
          0%, 100% {
            box-shadow: 0 0 0 0 rgba(115,211,141,.35);
          }
          50% {
            box-shadow: 0 0 0 6px rgba(115,211,141,0);
          }
        }

        .rr-admission-session {
          color: #e9d7a6;
          border: 1px solid rgba(229,200,120,.19);
          background: rgba(255,255,255,.045);
        }

        .rr-admission-session svg {
          color: var(--rr-gold-light);
        }

        .rr-admission-hero h1 {
          max-width: 880px;
          margin: 24px auto 0;
          color: white;
          font-family:
            ...
            "Times New Roman",
            serif;
          font-size: clamp(49px, 7.4vw, 79px);
          line-height: .98;
          letter-spacing: -.055em;
          font-weight: 700;
        }

        .rr-admission-title-rule {
          display: flex;
          align-items: center;
          justify-content: center;
          gap: 7px;
        ...
        .rr-admission-primary-btn,
        .rr-admission-light-btn,
        .rr-admission-outline-btn,
        .rr-admission-locked-btn {
          min-height: 47px;
          display: inline-flex;
          align-items: center;
          justify-content: center;
        ...
        .rr-admission-primary-btn:hover {
        ...
        .rr-admission-light-btn:hover,
        .rr-admission-outline-btn:hover {
          transform: translateY(-2px);
        }
        ...
        .rr-admission-locked-btn {
          color: #ffd3da;
          background: rgba(145,40,59,.25);
          border: 1px solid rgba(239,137,153,.22);
          cursor: not-allowed;
        }

        .rr-admission-hero-foot {
          display: flex;
          justify-content: center;
          align-items: center;
          gap: 19px;
        ...
        .rr-admission-hero-foot span {
          font-size: 8px;
          font-weight: 900;
          letter-spacing: .2em;
        }

        .rr-admission-hero-foot p {
          display: inline-flex;
          align-items: center;
          gap: 7px;
          margin: 0;
        ...
        .rr-admission-hero-foot p svg {
          color: var(--rr-gold-light);
        }

        .rr-admission-zigzag,
        .rr-admission-process-zigzag {
          position: absolute;
          z-index: 5;
          left: 0;
          right: 0;
        ...
        .rr-admission-zigzag div,
        .rr-admission-process-zigzag div {
          width: 100%;
          height: 100%;
          background: var(--rr-cream);
          clip-path:
        ...
        .rr-admission-heading {
          max-width: 710px;
          margin: 0 auto 48px;
          text-align: center;
        }

        .rr-admission-heading.light {
          color: white;
        }

        .rr-admission-small-label {
          display: inline-flex;
          align-items: center;
          gap: 8px;
          color: var(--rr-rose);
        ...
        .rr-admission-heading.light h2 {
          color: white;
        }

        .rr-admission-heading p {
          max-width: 650px;
          margin: 0 auto;
          color: var(--rr-muted);
          font-size: 12px;
        ...
        .rr-admission-closed {
          padding: 27px 0;
          border-bottom: 1px solid #e8d6da;
          background: #fff2f4;
        }

        .rr-admission-closed .rr-admission-shell {
          display: grid;
        ...
        .rr-admission-closed button {
          display: inline-flex;
          align-items: center;
          gap: 7px;
          padding: 11px 15px;
          border: 1px solid #dcb2bc;
          border-radius: 10px;
          color: #6e2337;
          background: white;
          cursor: pointer;
        ...
        .rr-admission-feature:hover {
          transform: translateY(-6px);
          border-color: #d8c39d;
          box-shadow:
            0 19px 45px rgba(50,35,30,.1);
        }

        .rr-admission-feature-number {
          position: absolute;
          right: 17px;
          top: 10px;
          color: #c9aa68;
        ...
        .rr-admission-feature-icon {
          ...
          box-shadow:
            0 9px 19px rgba(36,19,31,.14);
        }

        .rr-admission-feature h3 {
          margin: 0 0 9px;
          color: var(--rr-text);
          font-family:
            Georgia,
        ...
        .rr-admission-process::before {
          ...
          left: -230px;
          top: 40px;
          border: 1px solid rgba(229,200,120,.08);
          border-radius: 50%;
        }

        .rr-admission-process .rr-admission-shell {
          z-index: 2;
        }

        .rr-admission-timeline {
          position: relative;
          display: grid;
          grid-template-columns:
        ...
        .rr-admission-step:hover {
          transform: translateY(-5px);
          background: rgba(255,255,255,.065);
          border-color: rgba(229,200,120,.25);
        }

        .rr-admission-step-number {
          width: 47px;
          height: 47px;
          display: flex;
          align-items: center;
          justify-content: center;
          border: 1px solid rgba(229,200,120,.27);
          border-radius: 14px;
          color: var(--rr-gold-light);
        ...
        .rr-admission-step-copy {
          margin-top: 21px;
        }

        .rr-admission-step-copy > span {
          color: #bba97e;
          font-size: 8px;
          font-weight: 900;
          letter-spacing: .16em;
        ...
        .rr-admission-eligibility-grid {
          display: grid;
          grid-template-columns: 1fr 1fr;
          gap: 15px;
        }

        .rr-admission-eligibility-card {
          display: flex;
          gap: 15px;
          padding: 21px;
          border: 1px solid var(--rr-line);
          ...
          background: rgba(255,250,243,.88);
          box-shadow:
            0 8px 26px rgba(50,35,30,.04);
          transition:
            transform .25s ease,
            box-shadow .25s ease;
        }

        .rr-admission-eligibility-card:hover {
          transform: translateY(-4px);
          box-shadow:
            0 15px 34px rgba(50,35,30,.08);
        }

        .rr-admission-eligibility-icon {
          flex: 0 0 auto;
          width: 48px;
          height: 48px;
          display: flex;
        ...
        .rr-admission-eligibility-copy {
          min-width: 0;
          flex: 1;
        }

        .rr-admission-grade-row {
          display: flex;
          align-items: center;
        ...
        .rr-admission-eligibility-copy > p {
          margin: 8px 0 11px;
          color: var(--rr-muted);
          font-size: 10px;
          line-height: 1.7;
        ...
        .rr-admission-fee-card {
          ...
          box-shadow:
            0 25px 60px rgba(45,26,35,.18);
        }

        .rr-admission-fee-card::before {
          content: "";
          position: absolute;
          inset: 13px;
          border: 1px solid rgba(229,200,120,.13);
          border-radius: 20px;
          pointer-events: none;
        }

        .rr-admission-fe-decoration {
          position: absolute;
          right: 35px;
          top: 25px;
          display: flex;
        ...
        .rr-admission-fe-decoration span {
          width: 5px;
          height: 5px;
          border-radius: 50%;
        ...
        .rr-admission-fee-icon {
          ...
          justify-content: center;
          margin: 0 auto 21px;
          border: 1px solid rgba(229,200,120,.22);
          border-radius: 17px;
          color: var(--rr-gold-light);
          background: rgba(255,255,255,.055);
        }

        .rr-admission-fee-card > .rr-admission-small-label {
          color: #dbc58b;
        }

        .rr-admission-fee-card h2 {
          max-width: 700px;
          margin: 13px auto;
          color: white;
          font-family:
        ...
        .rr-admission-faq-item.expanded {
          border-color: #d9c39a;
          box-shadow:
            0 12px 30px rgba(50,35,30,.06);
        }

        .rr-admission-faq-item > button {
          width: 100%;
          min-height: 61px;
          display: flex;
          align-items: center;
        ...
        .rr-admission-faq-item > button > span {
          display: flex;
          align-items: center;
          gap: 10px;
        }

        .rr-admission-faq-item > button svg:first-child {
          flex: 0 0 auto;
          color: var(--rr-rose);
        }

        .rr-admission-faq-item > button > svg:last-child {
          flex: 0 0 auto;
          color: #a79a94;
          transition: transform .2s ease;
        }

        .rr-admission-faq-item > button > svg.rotate {
          transform: rotate(180deg);
          color: var(--rr-gold);
        }

        .rr-admission-faq-answer {
          overflow: hidden;
          border-top: 1px solid #eee4da;
        }

        .rr-admission-faq-answer p {
          margin: 0;
          padding: 15px 19px 18px 48px;
          color: var(--rr-muted);
          font-size: 10px;
          line-height: 1.8;
        }
        ...
        .rr-admission-contact-card:hover {
          transform: translateY(-5px);
          border-color: #d6c29f;
          box-shadow:
            0 16px 35px rgba(50,35,30,.08);
        }

        .rr-admission-contact-icon {
          width: 47px;
          height: 47px;
          display: flex;
          align-items: center;
        ...
        .rr-admission-contact-icon.phone {
          color: #3e7652;
          background: #e0f0e5;
        }

        .rr-admission-contact-icon.email {
          color: #754d6a;
          background: #eee2eb;
        }

        .rr-admission-contact-icon.hours {
          color: #856521;
          background: #f8edc9;
        }

        .rr-admission-contact-icon.location {
          color: var(--rr-rose);
          background: #f1dfe4;
        }

        .rr-admission-contact-card > span {
          color: #80736e;
          font-size: 8px;
          font-weight: 900;
          letter-spacing: .13em;
        ...
        .rr-admission-contact-card h3.email-text {
          font-family: inherit;
          font-size: 11px;
          word-break: break-word;
        }

        .rr-admission-contact-card small {
          display: inline-flex;
          align-items: center;
          gap: 5px;
          margin-top: auto;
        ...
        .rr-admission-final-badge svg {
          color: var(--rr-gold);
        }

        .rr-admission-final h2 {
          margin: 15px 0 13px;
          color: white;
          font-family:
            Georgia,
        ...
        .rr-admission-primary-btn.final {
          margin-top: 25px;
        }

        .rr-admission-final-contact-btn {
          display: inline-flex;
          align-items: center;
          gap: 8px;
          margin-top: 25px;
        ...
        .rr-admission-floating:hover {
          transform: translateY(-3px);
          box-shadow:
            0 17px 38px rgba(36,19,31,.26);
        }
        ...
        .rr-admission-modal-close:hover {
          transform: rotate(6deg);
          background: #eee2d8;
        }

        .rr-admission-modal-top {
          display: flex;
        ...
        .rr-admission-form-section {
          padding-top: 3px;
        }

        .rr-admission-form-section-title {
          display: flex;
          align-items: center;
          gap: 8px;
          padding-bottom: 11px;
        ...
        .rr-admission-form-section-title svg {
          color: var(--rr-rose);
        }

        .rr-admission-form-grid {
          display: grid;
          gap: 13px;
          margin-top: 15px;
        }

        .rr-admission-form-grid.three {
          grid-template-columns:
            repeat(3, minmax(0, 1fr));
        }

        .rr-admission-form-grid label,
        .rr-admission-message-field {
          display: flex;
          flex-direction: column;
          gap: 6px;
        }

        .rr-admission-form-grid label > span,
        .rr-admission-message-field > span {
          color: #6e625e;
          font-size: 8px;
          font-weight: 900;
          letter-spacing: .11em;
        ...
        .rr-admission-form-grid select,
        .rr-admission-message-field textarea {
          width: 100%;
        ...
        .rr-admission-form-grid input::placeholder,
        .rr-admission-message-field textarea::placeholder {
          color: #b0a49e;
        }

        .rr-admission-form-grid input:focus,
        .rr-admission-form-grid select:focus,
        .rr-admission-message-field textarea:focus {
          border-color: #bd8e96;
          box-shadow:
            0 0 0 4px rgba(166,43,79,.07);
        }

        .rr-admission-form-grid .span-three {
          grid-column: span 3;
        }

        .rr-admission-options {
          display: grid;
          grid-template-columns: 1fr 1fr;
          gap: 11px;
          margin-top: 15px;
        ...
        .rr-admission-options input {
          width: 15px;
          height: 15px;
          accent-color: var(--rr-rose);
        }

        .rr-admission-options svg {
          color: var(--rr-rose);
        }
        ...
        .rr-admission-form-footer > div:first-child {
          display: flex;
          align-items: center;
          gap: 7px;
          max-width: 300px;
        ...
        .rr-admission-form-footer > div:first-child svg {
          flex: 0 0 auto;
          color: #6f8d70;
        }

        .rr-admission-form-actions {
          display: flex;
          align-items: center;
          gap: 8px;
        }

        .rr-admission-form-actions button {
          min-height: 42px;
          padding: 0 15px;
          border-radius: 10px;
          cursor: pointer;
        ...
        .rr-admission-form-actions .cancel {
          border: 1px solid #ddd3ca;
          color: #6f6460;
          background: #f5eee7;
        }

        .rr-admission-form-actions .submit {
          display: inline-flex;
          align-items: center;
          gap: 7px;
          border: 1px solid #d9b34d;
          color: #2c2118;
          background:
            linear-gradient(
              135deg,
        ...
        .rr-admission-form-actions .submit:disabled {
          opacity: .55;
          cursor: not-allowed;
        }
        ...
        .rr-admission-success > div:first-child {
          width: 61px;
          height: 61px;
          display: flex;
          align-items: center;
        ...
        .rr-admission-success-actions button {
          padding: 10px 14px;
          border-radius: 9px;
          cursor: pointer;
          font-size: 9px;
        ...
        .rr-admission-success-actions .secondary {
          border: 1px solid #c4dcc9;
          color: #41654b;
          background: #e4f2e7;
        }

        .rr-admission-success-actions .primary {
          border: 1px solid #d7b350;
          color: #2e241a;
          background: #f0d176;
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          .red-rose-admissions *,
          .red-rose-admissions *::before,
          .red-rose-admissions *::after {
