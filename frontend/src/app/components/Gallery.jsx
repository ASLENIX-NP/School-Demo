...
const defaultGalleryContent = {
  ...
  description:
    "Step into the vibrant world of Smriti School — where every day is a new chapter in learning and discovery. From classrooms buzzing with curiosity to stages filled with confidence, from certificates of excellence to moments of pure joy, our gallery captures the heart of school life.",
