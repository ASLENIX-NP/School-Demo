...
function EditButton({
  ...
  return (
    <button
      ...
      className="absolute -right-3 -top-3 z-50 flex h-9 w-9 items-center justify-center rounded-full border-2 border-white bg-[#D9AA32] text-[#152438] shadow-xl opacity-100 sm:opacity-0 sm:group-hover:opacity-100 hover:scale-110 transition-all duration-200 cursor-pointer pointer-events-auto"
    >
...
export function Hero({
  ...
  /* =======================================================
     AUTO SLIDER - Disabled in Edit Mode
  ======================================================= */
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Decorative gold oval - Only active on public page */}
        {!editMode && (
          <motion.div
        ...
        <div className="grid w-full items-center gap-10 lg:grid-cols-[0.88fr_1.12fr] lg:gap-10 xl:gap-16">
          ...
          <div className="relative z-20">
            ...
            >
              {editMode ? (
                <div
                  className="inline-flex items-center gap-3 rounded-full border bg-white/80 px-5 py-3 shadow-sm backdrop-blur-xl"
                  style={{ borderColor: COLORS.border }}
                >
                  <Sparkles className="h-5 w-5" style={{ color: COLORS.gold }} />
                  <span className="text-sm font-black tracking-[0.28em] sm:text-base" style={{ color: COLORS.navy }}>
                    {heroData.badge}
                  </span>
                </div>
              ) : (
            ...
            >
              {editMode ? (
                <p className="mt-6 text-base font-black tracking-[0.38em] sm:text-lg" style={{ color: COLORS.gold }}>
                  {heroData.schoolName}
                </p>
              ) : (
                <motion.p
                  ...
                  className="mt-8 text-base font-black tracking-[0.38em] sm:text-lg"
            ...
            >
              {editMode ? (
                <h1
                  className="mt-3 max-w-2xl text-4xl font-black leading-[1.05] tracking-[-0.04em] sm:text-5xl md:text-6xl lg:text-[4rem]"
                  style={{ color: COLORS.navy }}
                >
                  {heroData.titleLine1}
                  <br />
                  <span style={{ color: COLORS.gold }}>{heroData.titleLine2}</span>
                </h1>
              ) : (
                <motion.h1
                  ...
                  className="mt-3 max-w-2xl text-5xl font-black leading-[0.98] tracking-[-0.045em] sm:text-6xl md:text-7xl lg:text-[4.5rem] xl:text-[5rem]"
                  style={{ color: COLORS.navy }}
                >
                  {heroData.titleLine1}
                  <br />
            ...
            >
              {editMode ? (
                <p className="mt-4 max-w-xl text-base leading-7 sm:text-lg sm:leading-8" style={{ color: COLORS.navySoft }}>
            ...
            >
              <div className="mt-4 flex flex-wrap items-center gap-x-6 gap-y-2">
                <span className="text-sm font-black tracking-[0.12em] sm:text-base" style={{ color: COLORS.navySoft }}>
                  {heroData.establishedYear}
                </span>
                <span className="h-2 w-2 rounded-full" style={{ background: COLORS.gold }} />
                <span className="flex items-center gap-2 text-base font-semibold sm:text-lg" style={{ color: COLORS.navySoft }}>
            ...
            >
              <div className="mt-5 flex flex-wrap gap-4">
                <Link
                  ...
                  className="group inline-flex items-center gap-3 rounded-full px-7 py-3.5 sm:px-8 sm:py-4 text-base font-black transition-all duration-300 hover:-translate-y-0.5 sm:text-lg"
                  style={{
                    color: COLORS.navy,
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full border bg-white/75 px-7 py-3.5 sm:px-8 sm:py-4 text-base font-bold shadow-sm backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:bg-white sm:text-lg"
                  style={{
                    color: COLORS.navy,
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-black uppercase tracking-[0.2em] sm:text-base" style={{ color: COLORS.navySoft }}>
                  A place to learn
                </p>
                <p className="mt-0.5 text-lg font-bold sm:text-xl" style={{ color: COLORS.navy }}>
                  A place to belong.
                </p>
              </div>
            </div>
          ...
          <div className="relative min-h-[360px] sm:min-h-[460px] lg:min-h-[540px] w-full">
            {/* GOLD 3D RING */}
            {!editMode ? (
              <motion.div
                className="absolute right-[-4%] top-[4%] h-[82%] w-[82%] rounded-[48%]"
                animate={{
                  rotate: [8, 10, 8],
                  y: [0, 8, 0],
                }}
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 35px 70px rgba(21,36,56,0.18), 0 14px 28px rgba(21,36,56,0.12)",
            ...
            >
              ...
              {editMode && (
                <button
                  ...
                  className="absolute right-20 top-5 z-30 flex items-center gap-2 rounded-full bg-white px-4 py-2.5 text-xs font-black text-[#152438] shadow-xl hover:scale-105 transition-transform cursor-pointer"
                >
              ...
              {images.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-4 top-1/2 z-30 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/85 text-[#152438] shadow-lg backdrop-blur-md transition-all hover:scale-110 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 z-30 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/85 text-[#152438] shadow-lg backdrop-blur-md transition-all hover:scale-110 cursor-pointer"
                  >
                    <ChevronRight className="h-5 w-5" />
                  </button>

                  <div className="absolute bottom-7 right-7 z-30 flex items-center gap-2 rounded-full bg-[#152438]/45 px-3 py-2 backdrop-blur-md">
                    {images.map((_, index) => (
                      <button
                        key={index}
                        type="button"
            ...
            {!editMode ? (
              <motion.div
                ...
                className="absolute bottom-[5%] left-0 z-40 rounded-[22px] border bg-white/90 px-5 py-4 shadow-xl backdrop-blur-xl sm:px-6 sm:py-5"
                style={{
                  borderColor: COLORS.border,
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[9px] font-black uppercase tracking-[0.18em]" style={{ color: COLORS.navySoft }}>
                      Our Philosophy
                    </p>
                    <p className="mt-0.5 text-sm font-black" style={{ color: COLORS.navy }}>
                      Learn • Lead • Serve
                    </p>
                  </div>
                </div>
              ...
              <div
                className="absolute bottom-[5%] left-0 z-40 rounded-[22px] border bg-white/95 px-5 py-4 shadow-xl backdrop-blur-xl sm:px-6 sm:py-5"
                style={{
                  borderColor: COLORS.border,
                  boxShadow: "0 16px 36px rgba(21,36,56,0.12)",
                }}
              >
                <div className="flex items-center gap-3">
                  <div
      ...
      {/* ===================================================
          BOTTOM SCROLL INDICATOR - Only on Public Page
      =================================================== */}
