...
export default function AdminFooter() {
  ...
  `}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        >
          <span
            className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold mb-2 sm:mb-3"
            style={{
        ...
        <div
          className="admin-footer-preview-frame rounded-2xl sm:rounded-3xl p-2.5 sm:p-4 md:p-5"
          style={{
            background:
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-5">
          <button
            ...
            className="rounded-xl p-3.5 sm:p-4 text-left bg-white border border-slate-100 hover:-translate-y-0.5 transition-all shadow-sm"
          >
            <UploadCloud className="w-4 h-4 mb-2" style={{ color: colors.purple }} />
            <div className="font-black text-xs sm:text-sm text-slate-950">Logo & School Info</div>
            <div className="text-[11px] sm:text-xs text-slate-500 mt-0.5">Logo, name, subtitle, admission badge.</div>
          </button>
          ...
          <button
            ...
            className="rounded-xl p-3.5 sm:p-4 text-left bg-white border border-slate-100 hover:-translate-y-0.5 transition-all shadow-sm"
          >
            <LinkIcon className="w-4 h-4 mb-2" style={{ color: colors.gold }} />
            <div className="font-black text-xs sm:text-sm text-slate-950">Edit Footer Links</div>
            <div className="text-[11px] sm:text-xs text-slate-500 mt-0.5">Add, edit, hide, or delete footer links.</div>
          </button>
          ...
          <button
            ...
            className="rounded-xl p-3.5 sm:p-4 text-left bg-white border border-slate-100 hover:-translate-y-0.5 transition-all shadow-sm"
          >
            <Share2 className="w-4 h-4 mb-2" style={{ color: colors.green }} />
            <div className="font-black text-xs sm:text-sm text-slate-950">Edit Social Links</div>
            <div className="text-[11px] sm:text-xs text-slate-500 mt-0.5">Add, edit, hide, or delete social links.</div>
          </button>
          ...
          <button
            ...
            className="rounded-xl p-3.5 sm:p-4 text-left bg-white border border-slate-100 hover:-translate-y-0.5 transition-all shadow-sm"
          >
            <Phone className="w-4 h-4 mb-2" style={{ color: colors.red }} />
            <div className="font-black text-xs sm:text-sm text-slate-950">Contact Details</div>
            <div className="text-[11px] sm:text-xs text-slate-500 mt-0.5">Address, map URL, phones, email.</div>
          </button>
        </div>
      </main>
